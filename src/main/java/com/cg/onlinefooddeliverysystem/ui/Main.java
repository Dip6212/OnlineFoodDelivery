...
public class Main {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    Customer customer = system.customers.get(0); 
    ...
    // Prompt manager for password and validate correctness
    private static boolean requestPassword(Manager manager) {
        System.out.print("Enter password: ");
        String inputPassword = sc.nextLine();
        return inputPassword.equals(manager.getPassword());
    }
